// .wrangler/tmp/bundle-vFXyrr/checked-fetch.js
...
// .wrangler/tmp/pages-GUFHW1/bundledWorker-0.4550111340018703.mjs
...
function remove_consumer(signal, dependency) {
  ...
  if (consumers !== null) {
    ...
    const index5 = consumers.indexOf(signal);
    if (index5 !== -1) {
      if (consumers_length === 0) {
        dependency.c = null;
      } else {
        consumers[index5] = consumers[consumers_length];
        consumers.pop();
      }
    }
  }
...
var FLUSH_MICROTASK;
var FLUSH_SYNC;
var current_scheduler_mode;
var is_micro_task_queued;
var is_flushing_effect;
var current_queued_pre_and_render_effects;
var current_queued_effects;
var flush_count;
var current_consumer;
var current_effect;
var current_dependencies;
var current_dependencies_index;
var current_untracked_writes;
var current_untracking;
var ignore_mutation_validation;
var current_skip_consumer;
var current_block;
var current_component_context;
var updating_derived;
var STATUS_MASK;
var ATTR_REGEX;
var CONTENT_REGEX;
var on_destroy;
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.BtlyyGgA.js", "_app/immutable/chunks/disclose-version.coSrcytf.js", "_app/immutable/chunks/runtime.Ja3GGWF_.js"];
    stylesheets = [];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.C0XOfgLf.js", "_app/immutable/chunks/disclose-version.coSrcytf.js", "_app/immutable/chunks/runtime.Ja3GGWF_.js", "_app/immutable/chunks/entry.B8zy3X4D.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.ymVh7aTm.js", "_app/immutable/chunks/disclose-version.coSrcytf.js", "_app/immutable/chunks/runtime.Ja3GGWF_.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});
...
var init_page_server_ts = __esm({
  ".svelte-kit/output/server/entries/pages/api/users/_page.server.ts.js"() {
  }
});
...
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/api/users/_page.svelte.js"() {
    init_chunks();
  }
});
var __exports4 = {};
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    server_id = "src/routes/api/users/+page.server.ts";
    imports4 = ["_app/immutable/nodes/3.pcYlWiQn.js", "_app/immutable/chunks/disclose-version.coSrcytf.js", "_app/immutable/chunks/runtime.Ja3GGWF_.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});
...
function mutable_source(initial_value) {
  ...
  if (current_component_context) {
    (current_component_context.d ??= []).push(s3);
  }
  return s3;
}
...
var state_proxy_handler = {
  defineProperty(target, prop, descriptor) {
    if (descriptor.value) {
      ...
      if (s3 !== void 0)
        set(s3, proxy(descriptor.value, metadata.i, metadata.o));
    }
  ...
  get(target, prop, receiver) {
    ...
    if (s3 === void 0 && (effect_active() || updating_derived) && (!(prop in target) || get_descriptor(target, prop)?.writable)) {
      s3 = (metadata.i ? source : mutable_source)(proxy(target[prop], metadata.i, metadata.o));
  ...
  has(target, prop) {
    ...
    let s3 = metadata.s.get(prop);
    if (s3 !== void 0 || effect_active() && (!has || get_descriptor(target, prop)?.writable)) {
      if (s3 === void 0) {
  ...
  set(target, prop, value, receiver) {
    const metadata = target[STATE_SYMBOL];
    let s3 = metadata.s.get(prop);
    if (s3 === void 0 && effect_active()) {
      untrack(() => receiver[prop]);
      s3 = metadata.s.get(prop);
    }
    if (s3 !== void 0) {
      set(s3, proxy(value, metadata.i, metadata.o));
    }
    const is_array2 = metadata.a;
...
function _mount(Component, options2) {
  ...
  const effect = render_effect(
    () => {
      ...
      component5 = // @ts-expect-error the public typings are not what the actual function looks like
  ...
  mounted_components.set(component5, () => {
    ...
    if (typeof thing?.then === "function") {
      ...
      thing.then(
        ...
        async ({ data, error }) => {
          ...
          push2(`<script>${global}.resolve(${str})<\/script>
`);
          if (count === 0)
            done();
        }
...
var manifest = (() => {
  ...
  return {
    ...
    _: {
      client: { "start": "_app/immutable/entry/start.CiIrAw-G.js", "app": "_app/immutable/entry/app.BnX4BFYI.js", "imports": ["_app/immutable/entry/start.CiIrAw-G.js", "_app/immutable/chunks/entry.B8zy3X4D.js", "_app/immutable/chunks/runtime.Ja3GGWF_.js", "_app/immutable/entry/app.BnX4BFYI.js", "_app/immutable/chunks/runtime.Ja3GGWF_.js", "_app/immutable/chunks/disclose-version.coSrcytf.js"], "stylesheets": [], "fonts": [], "uses_env_dynamic_public": false },
      nodes: [
...
// .wrangler/tmp/pages-GUFHW1/b992sh9ilbm.js
...
// .wrangler/tmp/bundle-vFXyrr/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-vFXyrr/middleware-loader.entry.ts
